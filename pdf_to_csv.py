...
def pdf_to_csv(pdf_path, csv_path):
            ...
            while i < len(participants_data):
                if participants_data[i] != '':
                    ...
                    if len(data) >= 5:
                        ...
                        for word in reversed(data[:-2]):  # Exclude the last two elements
                        ...
                        athlete_name = " ".join(data[1:data.index(year)])  # Join the name parts
                    ...
                    participants_list.append([bib_number, athlete_name, year, team, nationality, race_time])
    ...
    with open(csv_path, mode="w", newline="", encoding="utf-8") as csv_file:
        ...
        writer.writerow(['position', 'bib number', 'athlete', 'year', 'team', 'nationality', 'race time'])
